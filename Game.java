...
public class Game
{
    ...
    /**
     * clear the current challenge sequence and previous player input
     * Generates random numbers from 1-4 and puts them in random order incrementing the
    ...
    /**
     * Checks to see the player has finished entering the challenge
     * and calls another method to see if they have leveld
     * 
    ...
    /**
     * If the player has gotten the challenge right, add one to the level, and call the other methods 
     * to make a new challenge and to check if the blinks needs to be upped.
     * Else, take one away from the level and check if the blinks needs to be lowered.
     */
    private void level()
    {
        if(compareList())
    ...
    /**
     * if level is a certain number, change the blinks to reflect it.
     * If it is lower than 3, set the blinks to 3
     * if it is 3, set blinks to 4
     * if level is 6, set blinks to 5
     * if level is 9, set blinks to 6
     */
    private void blinks()
    {
        switch(difficulty)
